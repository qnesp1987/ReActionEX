...
public class ReActionEx(IDalamudPluginInterface pluginInterface) : DalamudPlugin<Configuration>(pluginInterface), IDalamudPlugin
{
    ...
    protected override void Initialize()
    {
        ...
        actionSheet = DalamudApi.DataManager.GetExcelSheet<Lumina.Excel.GeneratedSheets.Action>()?.Where(i => i.ClassJobCategory.Row > 0 && (i.ActionCategory.Row <= 4 || i.ActionCategory.Row == 9) && i.RowId > 8).ToDictionary(i => i.RowId, i => i);
