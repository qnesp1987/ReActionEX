...
public unsafe class CameraRelativeActions : PluginModule
{
    ...
    private static bool CheckAction(uint actionType, uint actionID, uint adjustedActionID)
    {
        ...
        if (ReActionEx.Config.EnableCameraRelativeDirectionals && a.IsPlayerAction && (a.Unknown50 == 6 || (a.CastType is 3 or 4 && a.CanTargetSelf))) return true; // Channeled abilities and cones and rectangles
